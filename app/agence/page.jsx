    ...
    return (
        <div>
            <div className="section1">
                <div ref={imageDivRef} className="rounded-2xl absolute overflow-hidden lg:top-52 lg:left-[30vw] left-[25vw]">
                    <Image
                        ref={imageRef}
                        src={currentImage}
                        alt="Floating Image"
                        width={230}
                        height={500}
                        className="rounded-2xl object-cover lg:h-[20vw] h-[27vw] lg:w-[15vw] w-[20vw]"
                    />
                </div>
                <div className="relative font-[font2]">
                    <div className="lg:mt-[55vh] mt-[23vh]">
                        <h1 className="lg:text-[20vw] text-[18vw] text-center lg:leading-[17vw] leading-[16vw] uppercase">Seven7y
                            Two
                        </h1>
                    </div>
                    <div className="lg:pl-[40%] pl-2 lg:mt-5 mt-25 lg:pr-5 pr-3">
                        <p className="lg:text-[55px] text-[21px] lg:leading-14 leading-[5vw]">
                            <span className="lg:mr-70 mr-25"></span>We’re inquisitive and open-minded, and we make sure creativity crowds out ego from every corner. A brand is a living thing, with values, a personality &nbsp; and a story. If we ignore that, we can achieve short-term success, but not influence that goes the distance. We bring that perspective to every brand story we help tell.
                        </p>
                    </div>
                </div>
            </div>
